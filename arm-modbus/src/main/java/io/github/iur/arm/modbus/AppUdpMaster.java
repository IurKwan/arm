...
public class AppUdpMaster extends ModbusMaster {
     ...
     */
    public AppUdpMaster(IpParameters params, int port) {
        this(params, false, port);
    }
     ...
     */
    public AppUdpMaster(IpParameters params, boolean validateResponse, int port) {
        ipParameters = params;
