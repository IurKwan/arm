...
import io.github.iur.arm.fragment.core.ArmFragmentDelegate
...
open class ArmFragment :
    ...
    override fun getSupportDelegate(): ArmFragmentDelegate = mDelegate
    ...
    override fun onAttach(activity: Activity) {
        ...
        _mActivity = mDelegate.activity as? ArmActivity
    }
    ...
    override fun onCreateAnimation(
        ...
        enter: Boolean,
        nextAnim: Int,
    ): Animation? = mDelegate.onCreateAnimation(transit, enter, nextAnim)
     ...
     */
    @Deprecated("Use post(Runnable) instead.")
     ...
     */
    final override fun isSupportVisible(): Boolean = mDelegate.isSupportVisible
     ...
     * 获取栈内的fragment对象
     */
    fun <T : IArmFragment> findChildFragment(fragmentClass: Class<T>): T? = SupportHelper.findFragment(childFragmentManager, fragmentClass)
}
