 ...
 */
fun <A : MavericksRepository<B>, B : MavericksState, C> withState(
    repository1: A,
    block: (B) -> C,
) = block(repository1.state)
 ...
 */
fun <
    A : MavericksRepository<B>,
    B : MavericksState,
    C : MavericksRepository<D>,
    D : MavericksState,
    E : MavericksRepository<F>,
    F : MavericksState,
    G : MavericksRepository<H>,
    H : MavericksState,
    I,
> withState(
    repository1: A,
