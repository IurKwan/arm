...
import io.github.iur.arm.mvi.common.MavericksRepository
import io.github.iur.arm.mvi.common.MavericksRepositoryConfig
import io.github.iur.arm.mvi.common.MavericksState
import io.github.iur.arm.mvi.common._internal
import io.github.iur.arm.mvi.common._internal1
import io.github.iur.arm.mvi.common._internal2
import io.github.iur.arm.mvi.common._internal3
import io.github.iur.arm.mvi.common._internal4
import io.github.iur.arm.mvi.common._internal5
import io.github.iur.arm.mvi.common._internal6
import io.github.iur.arm.mvi.common._internal7
import io.github.iur.arm.mvi.common._internalSF
...
abstract class MavericksViewModel<S : MavericksState>(
     ...
     */
    suspend fun awaitState(): S = repository.awaitState()
     ...
     */
    protected fun onEach(action: suspend (S) -> Unit) = repository._internal(action)
    ...
    private inner class Repository :
        ...
        fun <T : Any?> (suspend () -> T).executeInternal(
            ...
            retainValue: KProperty1<S, Async<T>>? = null,
            reducer: S.(Async<T>) -> S,
        ): Job = execute(dispatcher, retainValue, reducer)
        ...
        fun <T> Flow<T>.setOnEachInternal(
            dispatcher: CoroutineDispatcher? = null,
            reducer: S.(T) -> S,
        ): Job = setOnEach(dispatcher, reducer)
    }
}
